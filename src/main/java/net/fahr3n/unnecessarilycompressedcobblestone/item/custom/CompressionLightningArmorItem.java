...
/**
 * A piece of the Compression Lightning set. It behaves exactly like
 ...
 * real marker of a Lightning piece.
 */
public class CompressionLightningArmorItem extends CompressedCobblestoneArmorItem {
    public CompressionLightningArmorItem(Holder<ArmorMaterial> material, Type type, Properties properties) {
