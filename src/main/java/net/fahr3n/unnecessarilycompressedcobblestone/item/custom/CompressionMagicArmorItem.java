...
/**
 * A piece of the Compression Magic set. It behaves exactly like
 ...
 * real marker of a Magic piece.
 */
public class CompressionMagicArmorItem extends CompressedCobblestoneArmorItem {
    public CompressionMagicArmorItem(Holder<ArmorMaterial> material, Type type, Properties properties) {
