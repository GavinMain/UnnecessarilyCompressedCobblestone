...
/**
 * A piece of the Compression Rain set. It behaves exactly like
 ...
 * real marker of a Rain piece.
 */
public class CompressionRainArmorItem extends CompressedCobblestoneArmorItem {
    public CompressionRainArmorItem(Holder<ArmorMaterial> material, Type type, Properties properties) {
