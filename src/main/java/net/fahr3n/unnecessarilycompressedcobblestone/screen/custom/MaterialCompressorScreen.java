...
public class MaterialCompressorScreen extends AbstractContainerScreen<MaterialCompressorMenu> {
    ...
    public MaterialCompressorScreen(MaterialCompressorMenu menu, Inventory playerInventory, Component title) {
